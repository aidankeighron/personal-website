...
The code shown here has been modified to make it easier to explain. If you would like to check it out, the full code is available on GitHub: <a href="https://github.com/aidankeighron/PID-visualizer">PID Visualizer</a>
...
<img src="/images/pid-visual/not-enough-Derivative.png" style={{'border':"5px solid black", 'display': 'block', 'marginLeft': 'auto', 'marginRight': 'auto', 'width': '60%'}}></img>
...
<MathBlock math={String.raw`output = P + I + D`} />

#### Proportional Term (P):

<MathBlock math={String.raw`P = kP * error`} />
...
<img src="/images/pid-visual/K-factor-too-low.png" style={{'border':"5px solid black", 'display': 'block', 'marginLeft': 'auto', 'marginRight': 'auto', 'width': '60%'}}></img>
* To low of a kP term

#### Integral Term (I):

<MathBlock math={String.raw`I = kI * \int_0^t error(T) \,dT`} />
...
<img src="/images/pid-visual/Derivative-too-low.png" style={{'border':"5px solid black", 'display': 'block', 'marginLeft': 'auto', 'marginRight': 'auto', 'width': '60%'}}></img>
* Here you can see oscillation within a PID, probably too high of a kI

#### Derivative Term (D):

<MathBlock math={String.raw`D = kD * \frac{\mathrm{d} error}{\mathrm{d}t}`} />
...
<img src="/images/pid-visual/PID_Showcase.gif" style={{'border':"5px solid black", 'display': 'block', 'marginLeft': 'auto', 'marginRight': 'auto', 'width': '60%'}}></img>
...
<img src="/images/pid-visual/Motion-Profile-Feature.jpg" style={{'border':"5px solid black", 'display': 'block', 'marginLeft': 'auto', 'marginRight': 'auto', 'width': '60%'}}></img>

To get from this path to motor output, we need to do some math:

<MathBlock math={String.raw`output = v(t) * kV + a(t) * kA + cos(p(t)) * kG + kS * sign(v(t))`} />
...
Full code: <a href="https://github.com/aidankeighron/PID-visualizer">PID Visualizer</a>
