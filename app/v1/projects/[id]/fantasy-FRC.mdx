...
If you would like to check it out, the full code is available on GitHub: <a href="https://github.com/aidankeighron/fantasy-FRC" target="_blank">Fantasy FRC</a>.
