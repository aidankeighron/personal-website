...
export default function AboutMe() {
    return (
      <div className='flex items-center flex-col'>
          <div id={'aboutme'} className='max-w-[1500px] mx-[5%] bg-a-third dark:bg-d-third flex flex-col md:flex-row items-center rounded-2xl p-4 shadow-xl'>
            <m.div
